  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0a0f] to-[#12121a] pb-8">
      ...
      <header className="pt-4 sm:pt-6 pb-2 px-4 text-center">
        <h1 className="text-xl sm:text-2xl font-bold text-white mb-1" style={{ fontFamily: "'Space Grotesk', sans-serif" }} data-testid="app-title">
          Byron Bay Silent Disco
        </h1>
        <h2
            ...
            <ScrollArea className="h-[350px] sm:h-[400px]">
              <div className="space-y-2 pr-2">
                {queue.map((track, index) => (
                  <Card
                    key={track.uri + index}
                    className={`bg-[#1a1a24] border p-2.5 sm:p-3 flex items-center gap-2 sm:gap-3 transition-all ${
